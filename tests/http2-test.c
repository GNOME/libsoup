...
do_post_blocked_async_test (Test *test, gconstpointer data)
{
        ...
        GInputStream *in_stream = soup_body_input_stream_http2_new (NULL, 0);
...
do_flow_control_buffer_sizes (Test *test, gconstpointer data)
{
        ...
        // Assert that we have not already buffered the whole response.
        ...
        // Assert that the buffer never grew.
        g_assert_cmpint (buffer_size, ==, soup_body_input_stream_http2_get_buffer_size (get_body_stream_from_response (response_stream)));
