...
static GPtrArray *
soup_session_get_supported_websocket_extension_for_message (SoupSession *session,
                                                            SoupMessage *msg)
{
...
websocket_connect_async_stop (SoupMessage *msg, gpointer user_data)
{
	...
	supported_extensions = soup_session_get_supported_websocket_extension_for_message (session, msg);
