...
soup_server_class_init (SoupServerClass *server_class)
{
	...
	g_object_class_install_property (
         ...
         *
         * Add support for #WebsocketExtension of the given type.
         ...
         *
         * Remove support for #WebsocketExtension of the given type. (Shortcut for
...
#ifndef HAVE_ZLIB
        if (g_type_is_a (extension_type, SOUP_TYPE_WEBSOCKET_EXTENSION_DEFLATE))
                return;
#endif
