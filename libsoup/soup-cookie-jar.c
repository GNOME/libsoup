...
static gboolean
cookie_is_valid_for_same_site_policy (SoupCookie *cookie, const char *method, SoupURI *uri, SoupURI *top_level, SoupURI *cookie_uri, gboolean is_top_level_navigation, gboolean for_http)
{
...
static GSList *
get_cookies (SoupCookieJar *jar, SoupURI *uri, SoupURI *top_level, SoupURI *site_for_cookies, const char *method, gboolean for_http, gboolean is_top_level_navigation, gboolean copy_cookies)
{
	SoupCookieJarPrivate *priv;
		...
		while (domain_cookies) {
			...
			if (cookie->expires && soup_date_is_past (cookie->expires)) {
				...
				g_hash_table_insert (priv->domains,
			           ...
			           cookie_is_valid_for_same_site_policy (cookie, method, uri, top_level, site_for_cookies, is_top_level_navigation, for_http) &&
...
msg_starting_cb (SoupMessage *msg, gpointer feature)
{
	...
	cookies = soup_cookie_jar_get_cookie_list_full (jar, soup_message_get_uri (msg),
							     ...
							     msg->method,
							     TRUE, soup_message_get_is_toplevel_navigation (msg));
	if (cookies != NULL) {
